...
<form class="form-horizontal" action="forgotpasswordotp.php" method="POST">
<div class="form-group">
<label for="name" class="col-sm-2 control-label"><span class="glyphicon glyphicon-user"></span> Enter Mobile Number</label>
<div class="col-sm-10">
...
<button type="submit" class="btn btn-success btn-block" name="submit" id="submitbtn"><span class="glyphicon glyphicon-log-in"></span>Change Password</button>
</div>
</div>
</form>
</div>
