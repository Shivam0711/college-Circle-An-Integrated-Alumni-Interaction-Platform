...
{
$year=$_POST['year'];
$target_file = "placement/".rand(1,1000000).rand(1,100000).".pdf";
move_uploaded_file($_FILES["photo"]["tmp_name"], $target_file);
$obj= new functions();
$result=$obj->saveplacement($year,$target_file,$_SESSION['alumniname']);
?>
<!DOCTYPE html>
<html lang="en">
  <head> 
...
<div class="row">
<div class="col-md-12">
<div class="alert alert-info"><p class="text-center"> Upload Placement Data</p></div>
...
<p class="text-center">Placement Uploaded Successfully.Thank You</p>
</div>
<?php
}
else
...
<p class="text-center" >Placement Not Uploaded.</p>
</div>
<?php
}
}
