...
if(isset($_POST['submit']))
{
      ...
      if($_POST['newpassword']==$_POST['newpassword1'])
	  {
        $tablename='users';
        $obj= new functions();
        $result=$obj->changepassword1($tablename,$_POST['newpassword'],$user_id);
...
?>
	  <div class="col-sm-12 alert alert-danger"><p class="text-center">Password Change Unsuccessful.Please Try Again.</p>
</div>
<?php	  
	  }
	  }
	  ...
	  {
?>
       <div class="col-sm-12 alert alert-danger"><p class="Text Center">Password and Confirm Password Did Not Match. Please Try Again</p>
</div>
<?php
      }  
}
